...
const schoolsData: Record<string, SchoolData> = {
  ...
  '부천중': {
    ...
    features: [
      '부천중 내신 대비반 운영 (학교별 범위·일정 맞춤)',
      '개념 완성 + 유형 정리 집중 학습 (기초부터 탄탄하게)',
      '학교별 수행평가 대비 프로그램 (과제/발표/서술형/프로젝트)',
      '단원별 핵심 문제 + 실전 테스트 반복 (오답까지 관리)',
      '시험 2~3주 전 집중 대비 (예상문제 + 실전훈련)',
      'ICC 학습관리 코칭 시스템 운영 (플래너/누적 복습/과제 관리)',
      '1:1 질의응답 및 보강 시스템 운영 (약점 즉시 보완)'
    ]
  },
  '중흥중': {
    name: '중흥중',
