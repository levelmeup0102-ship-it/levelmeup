...
const Events: React.FC = () => {
  ...
  const programsContent = [
    ...
    },
    {
      ...
      target: '고등부 (고1 ~ 고3) / 듣기 실수가 잦은 학생',
      date: '2026년 1월 26일 (월)',
      schedule: '1/26(월) 16:00 ~ 17:30',
      bgColor: 'linear-gradient(135deg, #E1F5FE 0%, #B3E5FC 100%)',
      description: '고등 영어 듣기에서 자주 틀리는 포인트를 집중 보완하는 1회 특강입니다.',
      details: [
        '실전 듣기 문제풀이 + 오답 원인 교정',
    ...
    },
    {
      ...
      target: '고등부 (고1 ~ 고3) / 선택과목 언어와 매체 수강 학생',
      date: '주 1회 (3h)',
      schedule: '매주 수요일 13:00 ~ 16:00',
      bgColor: 'linear-gradient(135deg, #F3E5F5 0%, #E1BEE7 100%)',
      description: '방학 동안 언어와 매체 필수 개념을 빠르게 1회독하고, 내신·수능 기출 문제 풀이까지 연결해 실전 적용력을 완성하는 특강입니다.',
      details: [
        '자체 제작 교재로 언어와 매체 핵심 개념 총정리',
  ...
  const managementContent = [
    ...
    },
    {
      ...
      date: '매 학기 진행',
      bgColor: 'linear-gradient(135deg, #FFF9C4 0%, #FFF59D 100%)',
      description: '목표 설정부터 과정 관리, 결과 보상까지 연결되는 학기 단위 성취 관리 프로그램입니다.',
      details: [
        '학기 초 개인별 목표 등급·목표 점수 설정',
        '주간 학습 진도 점검 및 피드백(루틴·오답·과제 포함)',
        '성적 향상 달성 시 혜택 제공(학습 동기 강화)',
        '1등급 달성 및 우수 성과 학생 시상',
        '우수학생 '명예의 전당' 게시로 성취 경험 강화'
      ]
    }
  ];
